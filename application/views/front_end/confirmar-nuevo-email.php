    ...
    <div class="sections">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="animation centrar" data-animate="bounceIn">
                ...
                <div class="col-md-10">
                    <article id="preferencias" class="seccion-restaurante">
                        <h5>¡ Has modificado tu email !</h5>
                        <div class="row">
                            <div class="col-md-7">
                                <p>Ya puedes utilizar tu nuevo email para logarte y acceder a tu panel de control.</p>
                            </div>
                            <div class="col-md-5">
                                <a href="<?php echo base_url('panel-restaurador'); ?>">
                                    <input type="button" class="button-3" value="Entrar al panel de control">
                                </a>
                            </div>
                        </div>
                    </article>
